...
| 1 | "记个点子"、"存个金句"、"有个想法" | **模式 B：资产管理** | [mode-b-asset.md](references/modes/mode-b-asset.md) |
| 2 | "今天有什么AI新闻"、"推荐资讯" | **模式 A：AI新闻推荐** | [mode-a-news.md](references/modes/mode-a-news.md) |
